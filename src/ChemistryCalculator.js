...
const ChemistryCalculator = () => {
  ...
  // Changed to symbolic initial values
  ...
  // Added numerical states for calculation
  ...
  const [numericalInitialTemperature, setNumericalInitialTemperature] =
    useState(300);
  const [numericalFinalPressure, setNumericalFinalPressure] = useState(1.0);
  const [numericalFinalTemperature, setNumericalFinalTemperature] =
    useState(300);
